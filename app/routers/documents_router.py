...
from app.service.embedding.embedding_service import embedding_service
...
async def upload_documents(
    ...
    for file in files:
        ...
        embedding_service.run_embedding(document.public_id, db_session, document_repository, embedding_repository)
